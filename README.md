...
- **Перетаскивание с зажатой левой кнопкой**: Перемотка в любом месте кадра — веди влево/вправо. Чувствительность та же, что у тачпада: 100 px ≈ 5 секунд. На время жеста видео встаёт на паузу и продолжает играть после отпускания; `Escape` отменяет перемотку и возвращает исходную позицию.
